...
/**
 * Standard shadcn/ui table primitives. These are pure styling wrappers
 * over the native `<table>` element — they pair well with TanStack
 * Table's headless model: TT owns the data + state, these components
