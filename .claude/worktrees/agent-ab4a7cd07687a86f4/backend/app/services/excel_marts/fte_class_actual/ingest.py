"""fte_class_actual IngestJob — Job class FTE actual projections.xlsx."""
...
from app.services.excel_marts.fte_class_actual.schema import TABLE_NAME
...
job = register_job(
    IngestJob(
        name="fte_class_actual",
        source_file="Job class FTE actual projections.xlsx",
